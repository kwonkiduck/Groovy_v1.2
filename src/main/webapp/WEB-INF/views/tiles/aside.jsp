    ...
    <div id="sideBar">
                ...
                <div class="user-service">
                    <ul class="font-11 font-reg">
                        <li><i class="icon i-mail"></i><span>메일</span><a
                                href="${pageContext.request.contextPath}/email/all" id="linkMail"></a></li>
                        <li><a href="${pageContext.request.contextPath}/employee/myInfo" id="settingMyinfo">내 정보 관리</a>
                        </li>
                    </ul>
                </div>
                <div class="btn-wrap">
        ...
        <nav id="nav">
            ...
            <div class="team">
                ...
                <ul>
                    <li class="nav-list"><a href="${pageContext.request.contextPath}/calendar/emplScheduleMain"><i
            ...
            <div class="company">
                ...
                <ul>
                    <li class="nav-list"><a href="${pageContext.request.contextPath}/notice/loadNoticeList"><i
                            class="icon i-notice"></i>공지사항 (완료)</a></li>
                    <li class="nav-list"><a href="${pageContext.request.contextPath}/club"><i class="icon i-share"></i>동호회</a>
                    </li>
                    <li class="nav-list"><a href="${pageContext.request.contextPath}/common/loadOrgChart"><i
                            class="icon i-org"></i>조직도 (완료)</a></li>
                </ul>
            </div>
        </nav>
    </div>
