...
<table border="1" style="width: 50%;">
    ...
    <tr>
        ...
        <td class="modifyTd"><input type="text" name="modifyJobRecptnEmplId" id="modifyJobRecptnEmplId" readonly
                                    value="최아리"></td>
    </tr>
    <tr>
        <th>업무 기간</th>
    ...
    <tr>
        ...
        <td class="modifyTd"><input type="text" name="modifycommonCodeDutyProgrs" id="modifycommonCodeDutyProgrs"
                                    readonly value="승인"></td>
    </tr>
    <tr>
        <td colspan="2">
            <button id="modifyJobBtn">수정</button>
            <button id="updateJobBtn" style="display: none;">저장</button>
            <button id="cancelJobBtn">취소</button>
        </td>
    </tr>
</table>
<br/><br/>
